...
/**
 *2nd Shooter Client Class with individual input and output streams 
 * from 1st Shooter Client Class. Class requests shot results from server
 ...
 *
 */
public class Shooter2 implements Runnable{
	 ...
	 */
	public Shooter2(String IP, int portnum, int rindex){
	...
	public void run() {
		try {
			...
			System.out.println("Shooter 2" +Arrays.toString(Project_Main.connected));
	...
	private void processConnection() throws IOException{
		...
		System.out.println("<2>Your board is displayer");
